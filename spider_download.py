                ...
                if task_type == 'baidu_firstPage':
                    ...
                    if self.b_add:
                        if domain.strip():
                            ...
                            #     search_word, domain
                            # )
                            url = 'https://www.baidu.com/s?ie=utf-8&f=8&rsv_bp=1&rsv_idx=1&tn=baidu&wd={}&fenlei=256&rsv_pq=a0dbf9a50084394b&rsv_t=d56cOy5hF0aPnkSY3CjC%2BQMa4O9m2aRFU897qWgl6XzhYqtxh3P2odL%2BBGw&rqlang=cn&rsv_enter=0&rsv_dl=tb&rsv_btype=i&inputT=1313&si={}&ct=2097152&gpc=stf%3D1610329351%2C1610934151%7Cstftype%3D1'.format(
                                search_word, domain
                            )
                        else:
                            ...
                            #     search_word
                            # )
                            url = 'https://www.baidu.com/s?ie=utf-8&f=8&rsv_bp=1&rsv_idx=1&tn=baidu&wd={}&fenlei=256&oq=%25E5%259B%25BD%25E5%25AE%25B6%25E5%25BC%2580%25E5%258F%2591%25E9%2593%25B6%25E8%25A1%258C%2520%25E6%258A%2595%25E8%25B5%2584&rsv_pq=c344acc0008c21b2&rsv_t=1bb2y%2BSBngMk5XbVEnZgGORnAoS%2BdxDEnZLAR5%2BcPC9xDG6Yt8fDhmhsfsM&rqlang=cn&rsv_enter=0&rsv_dl=tb&rsv_btype=t&gpc=stf%3D1610329516%2C1610934316%7Cstftype%3D1&tfflag=1'.format(
                                search_word
                            )
                    else:
                        if domain.strip():
